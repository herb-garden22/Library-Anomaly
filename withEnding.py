        ...
        if self.currentRoom == "???":
            if key == 'a': 
                if "Key" in self.inventory:
                    ...
                    self.master.after(6000, self.updateDisplay) #Pause for 6 seconds to let the player read the message
                else:
